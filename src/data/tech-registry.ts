...
const TECH_REGISTRY = {
  ...
  // ===== Métier / Business =====
  'Data-Driven': { color: '#2563EB' },
  'No-Code': { color: '#8B5CF6' },
  'Product Leadership': { color: '#0891B2' },
  'AI': { color: '#7C3AED' },
  'Training': { color: '#059669' },
  'Change Management': { color: '#D97706' },
  'B2B Strategy': { color: '#DC2626' },
  'Management': { color: '#2563EB' },
  'Web3': { color: '#6366F1' },
  'Innovation': { color: '#EC4899' },
  'Banking': { color: '#0D9488' },
  'Sales': { color: '#EA580C' },
  'Community': { color: '#10B981' },
  'Digital': { color: '#3B82F6' },
  'Data': { color: '#6366F1' },
  'Insurance': { color: '#0284C7' },
  'Stratégie': { color: '#DC2626' },
  'Roadmap': { color: '#8B5CF6' },
  'Veille': { color: '#0891B2' },
  'Business Model': { color: '#EA580C' },
  'Gouvernance': { color: '#2563EB' },
  'Conduite du changement': { color: '#D97706' },
  ...
  'B2B': { color: '#EA580C' },
  'B2C': { color: '#10B981' },
  'Développement commercial': { color: '#0284C7' },
