...
const TECH_REGISTRY = {
  ...
  // ===== Métier / Business =====
  // Indigo : Cabinet Hacktion (identité)
  'Hacktion': { color: '#4F46E5' },
  // Violet : IA & Data
  'Open Data': { color: '#7C3AED' },
  'Data-Driven': { color: '#7C3AED' },
  'AI': { color: '#7C3AED' },
  'IA': { color: '#7C3AED' },
  'Data/IA': { color: '#7C3AED' },
  'Data': { color: '#7C3AED' },
  'No-code': { color: '#7C3AED' },
  'Vibe Coding': { color: '#7C3AED' },
  // Bleu : Tech & Méthodes
  'Prototyping': { color: '#2563EB' },
  'Prototype': { color: '#2563EB' },
  'Agile': { color: '#2563EB' },
  'OKR': { color: '#2563EB' },
  ...
  'Roadmap': { color: '#EA580C' },
  'Business Model': { color: '#EA580C' },
  'Stratégie': { color: '#EA580C' },
  'Veille': { color: '#EA580C' },
  // Vert : Management & RH
  'Management': { color: '#059669' },
  'Gouvernance partagée': { color: '#059669' },
  'Change Management': { color: '#059669' },
  'Conduite du changement': { color: '#059669' },
  'Formation': { color: '#059669' },
  'Training': { color: '#059669' },
  // Rouge : Business Dev
  'B2B Strategy': { color: '#DC2626' },
  'Stratégie B2B': { color: '#DC2626' },
  'Développement commercial': { color: '#DC2626' },
  'B2B': { color: '#DC2626' },
  'B2C': { color: '#DC2626' },
  'Sales': { color: '#DC2626' },
  // Cyan : Secteurs
  'Insurance': { color: '#0891B2' },
  'Assurance': { color: '#0891B2' },
  'Banking': { color: '#0891B2' },
  'Banque': { color: '#0891B2' },
  // Rose : Innovation & Communauté
  'Innovation': { color: '#EC4899' },
  'Web3': { color: '#EC4899' },
  'Community': { color: '#EC4899' },
  'Communauté': { color: '#EC4899' },
